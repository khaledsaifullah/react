...
const TestConsultancyRoutes = React.lazy(() => import('../modules/TestConsultancy/TestConsultancyRoutes'));
const HealthRoutes = React.lazy(() => import('../modules/Health/HealthRoutes'));
        ...
        <Routes>
            <Route element={<ProtectedAdminRoute />}>
                ...
                <Route element={<AdminTheme.Common.MainLayout />}>
                    ...
                    <Route path={'/test-consultancy/*'} element={<TestConsultancyRoutes />} />
