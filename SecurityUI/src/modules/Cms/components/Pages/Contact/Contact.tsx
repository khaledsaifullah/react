...
const Contact: FC<any> = (props) => {
    ...
    return (
        <div className="container">
            <ContextJSX>
                <MetaTag>
                    <MetaTag.Title>{t('Contact us')}</MetaTag.Title>
                </MetaTag>
                <Header>
                    <Header.PageTitle>{t('Contact us')}</Header.PageTitle>
                </Header>
                <Breadcrumb>
                    <Breadcrumb.Item>{t('Contact us')}</Breadcrumb.Item>
                </Breadcrumb>
            </ContextJSX>
            <Card className="contact-page-card shadow rounded">
