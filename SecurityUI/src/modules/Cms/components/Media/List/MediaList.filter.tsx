...
const MediaListFilter: FC<any> = (props) => {
    ...
    <div className="listing-page-filter">
      <div className="filter-section filter-top">
        ...
        <div className="btn-group btn-group-right">
          <CreateAction
            actionItem={MediaAction.COMMON_ACTION.CREATE}
      ...
      <div className="filter-section filter-bottom">
        ...
        <div className="filter-bottom-right">
          ...
          <BulkAction
            bulkAction={MediaAction.BULK_ACTION}
            handleCallbackFunc={handleCallbackFunc}
          />
        </div>
      </div>
...
export default React.memo(MediaListFilter);
