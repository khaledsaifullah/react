...
import BlocksViewDrawer from "./BlocksView.drawer";
import { Message } from "../../../../../utils";
import { BlocksApi } from "../../../../../api";
import "../../../styles/Cms.module.view.scss";
import "./BlocksView.style.scss";

const initialState = {
  modalTitle: "Blocks Info",
  itemData: {},
  loading: false,
  fields: {},
};

const BlocksViewController: FC<any> = (props) => {
...
export default React.memo(BlocksViewController);
