...
import AddOrEditForm from "./BlocksForm.form";
...
const BlocksFormDrawer: FC<IProps> = (props) => {
  ...
  return (
    <Fragment>
      <Drawer
        ...
        className="form-page-drawer form-page-drawer-blocks"
        title={
          <b>
...
export default React.memo(BlocksFormDrawer);
