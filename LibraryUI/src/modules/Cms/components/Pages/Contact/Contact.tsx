...
const Contact: FC<any> = (props) => {
  ...
  return (
    <div className="pageone-content">
      <div className="header-banner contact-us-banner ">
        <img src={headerBanner} alt="headerbanner" />
      </div>

      <div className="page-wrapper-content page-contact-us">
        <h1>Contact us</h1>
        <div className="page-wrapper-contentbody">
          ...
          <div className="contact-rightpart">
            <h3>Feedback Submission Form</h3>
            <div className="contact-form">
              ...
              <Row gutter={[16, 16]}>
                <Col xs={24} md={24}>
                  <Button className="submitbtn-contact">Submit </Button>
                </Col>
              </Row>
            </div>
          </div>
