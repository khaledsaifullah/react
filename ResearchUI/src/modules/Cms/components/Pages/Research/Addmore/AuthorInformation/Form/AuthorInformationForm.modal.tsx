...
import AddOrEditForm from "./AuthorInformationForm.form";
...
const AuthorInformationFormModal: FC<IProps> = props => {
    ...
    return (
        <Fragment>
            <Modal
                width={1024}
                className="form-page-modal form-page-modal-papers-to-be-attached"
                ...
                footer={[
                    ...
                    <Button key='submit' type='primary' loading={loading} onClick={onSubmit}>{t('Save')}</Button>
                ]}
            >
...
export default React.memo(AuthorInformationFormModal);