...
import BookingPageFormController from "../Form/BookingDetailsForm.controller";
import BookingPageViewController from "../View/BookingDetailsView.controller";
import DeleteAction from "../../../../../../components/Actions/DeleteAction";
import ViewLink from "../../../../../../components/Link/ViewLink";
import EditLink from "../../../../../../components/Link/EditLink";

export const CustomerBillingInformationAction = {
    COMMON_ACTION: {
        CREATE: {
            type: 'item',
