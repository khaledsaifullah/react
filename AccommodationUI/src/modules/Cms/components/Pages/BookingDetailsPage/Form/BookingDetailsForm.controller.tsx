...
import AddOrEditForm from "./BookingDetailsForm.form";
...
const BookingDetailsFormController: FC<any> = props => {
...
export default React.memo(BookingDetailsFormController);
