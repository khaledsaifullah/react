...
import BookingPageView from "./BookingDetailsView.view";
...
const BookingDetailsViewController: FC<any> = props => {
    const { t } = useLang();
...
export default React.memo(BookingDetailsViewController);
