...
import AddOrEditForm from "./CustomerBillingInformationForm.form";
...
const CustomerBillingInformationFormController: FC<any> = props => {
...
export default React.memo(CustomerBillingInformationFormController);
