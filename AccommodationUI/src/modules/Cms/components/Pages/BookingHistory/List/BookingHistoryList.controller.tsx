...
import BookingPageListFilter from "./BookingHistoryList.filter";
import BookingPageListing from "./BookingHistoryList.listing";
import BookingPageListPagination from "./BookingHistoryList.pagination";
...
const BookingHistoryListController: FC = () => {
...
export default BookingHistoryListController;
