...
import AddOrEditForm from "./HomePageForm.form";
import { useLang } from "../../../../../../hooks/useLang";

const initialState = {
    pageTitle: 'Create HomePage',
    itemData: {},
    fields: {
        title: null,
        description: null,
...
const HomePageFormController: FC<any> = props => {
        ...
        return new Promise((resolve, reject) => {
            ...
            FackApi.create(payload)
                .then(res => {
                    ...
                    navigate(getAdminLangUrl(lang, '/setting/automation/homePage/list'));
                    setLoading(false);
    ...
    const handleUpdate = (values: any): Promise<any> => {
        return new Promise((resolve, reject) => {
            ...
            FackApi.update(entityId, payload)
                .then(res => {
                    Message.success(t('HomePage update successfully.'));
                    navigate(getAdminLangUrl(lang, '/setting/automation/homePage/list'));
                    setLoading(false);
                    setIsSubmitting(false);
                    resolve(res);
    ...
    return (
        <div className="form-page-container form-page-container-homePage">
            <AddOrEditForm
                loading={loading}
...
export default React.memo(HomePageFormController);
