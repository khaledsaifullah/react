...
import AddOrEditForm from "./ReviewAndFeedbackForm.form";
...
const ReviewAndFeedbackFormController: FC<any> = props => {
...
export default React.memo(ReviewAndFeedbackFormController);
