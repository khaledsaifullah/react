...
import BookingPageListFilter from "./ReviewAndFeedbackList.filter";
import BookingPageListing from "./ReviewAndFeedbackList.listing";
import BookingPageListPagination from "./ReviewAndFeedbackList.pagination";
...
const ReviewAndFeedbackListController: FC = () => {
...
export default ReviewAndFeedbackListController;
