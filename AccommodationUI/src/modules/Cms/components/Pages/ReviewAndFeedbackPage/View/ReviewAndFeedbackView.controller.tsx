...
import BookingPageView from "./ReviewAndFeedbackView.view";
...
const ReviewAndFeedbackViewController: FC<any> = props => {
    const { t } = useLang();
...
export default React.memo(ReviewAndFeedbackViewController);
