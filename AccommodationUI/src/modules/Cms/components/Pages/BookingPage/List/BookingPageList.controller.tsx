...
import BookingPageListFilter from "./BookingPageList.filter";
import BookingPageListing from "./BookingPageList.listing";
import BookingPageListPagination from "./BookingPageList.pagination";
...
const BookingPageListController: FC = () => {
...
export default BookingPageListController;
