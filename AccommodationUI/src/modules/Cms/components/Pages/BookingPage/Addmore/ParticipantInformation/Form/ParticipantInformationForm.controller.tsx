...
import ParticipantInformationForm from './ParticipantInformationForm.form';

const initialState = {
    modalTitle: 'Create Participant Information',
    itemData: {},
    fields: {
        name: null,
        designation: null,
...
const ParticipantInformationFormController: FC<any> = props => {
    ...
    useEffect(() => {
        if (entityIndex !== null) {
            ...
            setModalTitle('Edit Participant Information');
            setItemData(entity);
            setIsNewRecord(false);
            loadData();
        }
    ...
    return (
        <ModalForm
            ...
            formRef={formRef}
            component={ParticipantInformationForm}
...
export default React.memo(ParticipantInformationFormController);
