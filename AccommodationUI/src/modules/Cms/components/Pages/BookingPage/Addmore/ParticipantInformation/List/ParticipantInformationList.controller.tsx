...
import ParticipantInformationList from "./ParticipantInformationList";
import ParticipantInformationFormController from "../Form/ParticipantInformationForm.controller";
...
const ParticipantInformationListController: FC<IProps> = props => {
    ...
    const handleActions = (action: string, entityIndex?: any) => {
        ...
        if (action === 'add') {
            ...
            AntModal.confirm('Delete Participant Information', 'Are you sure you want to delete this Participant Information?', entityIndex, handleDeleteConfirm, 'Delete');
        }
    };
            ...
            <Row>
                <Col span={24}>
                    ...
                    <div className="add-more-action">
                        <ParticipantInformationFormController
                            entity={entity}
                        ...
                        <Space>
                            <button type="button" className="btn btn-primary rounded-1 mt-3 mb-3" onClick={() => handleShowForm()}>
                                <PlusOutlined /> <span>{t('Add Participant')}</span>
                            </button>
                        </Space>
                    </div>
                </Col>
...
export default ParticipantInformationListController;
