...
import AddOrEditForm from "./SearchAccommodationForm.form";
import { useLang } from "../../../../../../hooks/useLang";

const initialState = {
    pageTitle: 'Create SearchAccommodation',
    itemData: {},
    fields: {
        title: null,
        description: null,
...
const SearchAccommodationFormController: FC<any> = props => {
    ...
    useEffect(() => {
        if (entityId) {
            ...
            setPageTitle('Edit SearchAccommodation');
            resetForm();
            loadData();
        }
        else {
        ...
        return new Promise((resolve, reject) => {
            ...
            FackApi.create(payload)
                .then(res => {
                    ...
                    navigate(getAdminLangUrl(lang, '/setting/automation/searchAccommodation/list'));
                    setLoading(false);
    ...
    const handleUpdate = (values: any): Promise<any> => {
        return new Promise((resolve, reject) => {
            ...
            FackApi.update(entityId, payload)
                .then(res => {
                    Message.success(t('SearchAccommodation update successfully.'));
                    navigate(getAdminLangUrl(lang, '/setting/automation/searchAccommodation/list'));
                    setLoading(false);
                    setIsSubmitting(false);
                    resolve(res);
    ...
    return (
        <div className="form-page-container form-page-container-searchAccommodation">
            <AddOrEditForm
                loading={loading}
...
export default React.memo(SearchAccommodationFormController);
