...
import BookingPageListFilter from "./BookingDetailsList.filter";
import BookingPageListing from "./BookingDetailsList.listing";
import BookingPageListPagination from "./BookingDetailsList.pagination";
...
const BookingDetailsListController: FC = () => {
...
export default BookingDetailsListController;
