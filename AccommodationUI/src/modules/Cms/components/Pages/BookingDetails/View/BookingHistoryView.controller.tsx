...
import BookingPageView from "./BookingHistoryView.view";
...
const BookingHistoryViewController: FC<any> = props => {
    const { t } = useLang();
...
export default React.memo(BookingHistoryViewController);
