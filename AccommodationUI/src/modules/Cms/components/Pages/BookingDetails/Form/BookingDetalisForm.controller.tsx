...
import AddOrEditForm from "./BookingDetalisForm.form";
...
const BookingDetalisFormController: FC<any> = props => {
...
export default React.memo(BookingDetalisFormController);
