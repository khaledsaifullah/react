...
import AddOrEditForm from "./ReviewAndFeedbackDetailsForm.form";
...
const ReviewAndFeedbackDetailsFormController: FC<any> = props => {
...
export default React.memo(ReviewAndFeedbackDetailsFormController);
