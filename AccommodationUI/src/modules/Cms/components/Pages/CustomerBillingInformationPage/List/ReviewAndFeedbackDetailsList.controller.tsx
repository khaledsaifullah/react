...
import BookingPageListFilter from "./ReviewAndFeedbackDetailsList.filter";
import BookingPageListing from "./CustomerBillingInformationList.listing";
import BookingPageListPagination from "./ReviewAndFeedbackDetailsList.pagination";
...
const ReviewAndFeedbackDetailsListController: FC = () => {
...
export default ReviewAndFeedbackDetailsListController;
